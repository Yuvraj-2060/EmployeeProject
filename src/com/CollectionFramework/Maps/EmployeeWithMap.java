...
import com.CollectionFramework.model.Employee;

import java.time.LocalDate;
import java.util.HashMap;
import java.util.Map;

public class EmployeeWithMap {
    ...
    public static void main(String[] args) {
        ...
        //System.out.println(employees.get(findId));
        employees.values().stream()
                .filter(emp -> emp.getName().equals(findName))
                .findFirst()
                .ifPresentOrElse(
                        emp -> System.out.println("Employee found is " + findName + ": " + emp),
